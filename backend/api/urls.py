...
from .views import ProductViewSet, MenuEntryViewSet, SaleViewSet, ExpenseViewSet, InventoryItemViewSet, SupplierOrderViewSet, OrderStreamView, GlobalSettingViewSet
